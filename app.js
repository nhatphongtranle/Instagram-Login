...
document.querySelectorAll(".animate-input").forEach((e) => {
  ...
  input.onkeyup = () => {
    ...
    if (checkSigninInput()) {
      signin_button.removeAttribute("disable");
    } else {
      signin_button.setAttribute("disable");
    }
    signin_button.setAttribute("disable", "true");
  };
...
// Signin
checkSigninInput = () => {
  let inputs = signin.querySelectorAll("input");
